...
export default class HeartRateDisplay extends React.Component{
    state = {
        selectedOption : '',
        ...
        <View>
              ...
              <View style={{justifyContent:'center',alignItems:'center',elevation:10}}>
              ...
              
                    {
                        ...
                        <HeartRateWeekly email = {this.props.email} /> :
                        this.state.selectedOption == "Yearly" ? 
                        <HeartRate email = {this.props.email} />
                        :
                        this.state.selectedOption == "Monthly"?
                        <HeartRateMonthly email = {this.props.email} />
                        :
