...
// export default class HeartRateWeekly extends Component {
...
//             var c = {}
//             firebase.database().ref('history-reading/' + email + '/heartRate').on("value", function (snapshot) {
...
//                         var timeFromDB = arr2['time'].split(" ")
...
//             firebase.database().ref('history-reading/' + this.props.email + '/heartRate/').on("child_changed",(snapshot)=> {
...
export default class OxygenWeekly extends Component {
    ...
    Oxygen = () => {
        ...
        // var fetchData = new Promise((resolve, reject) => {
            ...
            var counting = 1
            console.log("fdata= ");
            firebase.database().ref('history-reading/' + email + '/pulseOx').on("child_added", (snapshot) => {
                // console.log(snapshot.val())
                var arr = snapshot.val()
                console.log("arr= ");
