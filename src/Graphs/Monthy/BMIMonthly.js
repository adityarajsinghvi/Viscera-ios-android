...
// export default class BMIMonthly extends Component {
...
//             var feets = parseInt(snapshot.val().feets)
...
//             }
//             for(var i=0;i<12;i++) {
//                 w[i] = w[i]/(this.state.heightMeters*this.state.heightMeters);
//             }
//             console.log("q, w",q, w);
...
//             firebase.database().ref('history-reading/' + email + '/weight').on("child_added", function (snapshot) {
